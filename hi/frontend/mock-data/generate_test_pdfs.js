 ...
 * 
 * This script creates simple text-based "PDFs" (not true PDF format for simplicity)
 * but includes all necessary metadata for testing extraction logicUsage:
 *   node generate_test_pdfs.js [--output-dir=./pdfs]
 */
...
Test Name               Value   Unit         Reference      Status
Creatinine              1.3     mg/dL        0.6-1.2        HIGH ⚠️
BUN                     24      mg/dL        7-20           HIGH ⚠️
GFR (estimated)         58      mL/min       >60            LOW  ⚠️
...
Test Name                    Value   Unit      Reference       Status
Fasting Blood Glucose        156     mg/dL     70-100          HIGH ⚠️⚠️
Postprandial Glucose (2hr)   238     mg/dL     <140            CRITICAL ⚠️⚠️
HbA1c                        8.9     %         <5.7            HIGH ⚠️⚠️
Glycated Albumin             28      %         <17             HIGH ⚠️

---LIPID PROFILE (DIABETIC)---
Total Cholesterol            245     mg/dL     <200            HIGH ⚠️
LDL Cholesterol              165     mg/dL     <100            HIGH ⚠️
HDL Cholesterol              32      mg/dL     >50             LOW  ⚠️
Triglycerides                285     mg/dL     <150            HIGH ⚠️
...
try {
  ...
  console.log(`⚠️  Note: These are text files for testing. In production, generate actual PDF files.\n`);
} catch (err) {
