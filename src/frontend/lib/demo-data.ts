...
export interface MedicalReport {
  ...
  pageCount: number;
  /** Simulated OCR snippet — first ~200 chars of extracted text */
  ocrSnippet?: string;
...
export const DEMO_REPORTS: MedicalReport[] = [
  {
    ...
    status: "ready",
    pageCount: 3,
    ocrSnippet: "COMPLETE BLOOD COUNT\nPatient: Riya Sharma  Date: 15-Jan-2026\nHaemoglobin: 9.8 g/dL  [Ref: 12.0–16.0]  LOW\nSerum Iron: 42 µg/dL  [Ref: 60–170]  LOW\nFerritin: 7 ng/mL  [Ref: 12–150]  LOW\nWBC: 7200 cells/µL  [Ref: 4500–11000]  NORMAL",
    extractedResults: [
  ...
  },
  {
    ...
    status: "ready",
    pageCount: 2,
    ocrSnippet: "LIPID PANEL REPORT\nPatient: Riya Sharma  Date: 01-Mar-2026\nTotal Cholesterol: 215 mg/dL  [Ref: <200]  HIGH\nLDL Cholesterol: 138 mg/dL  [Ref: <100]  HIGH\nHDL Cholesterol: 55 mg/dL  [Ref: >50]  NORMAL",
    extractedResults: [
  ...
  },
  {
    ...
    status: "ready",
    pageCount: 2,
    ocrSnippet: "DIABETES MANAGEMENT PANEL\nPatient: Karan Patel  Date: 20-Feb-2026\nHbA1c: 7.8%  [Ref: 4.0–5.7%]  HIGH — Diabetic Range\nFasting Glucose: 142 mg/dL  [Ref: 70–100]  HIGH",
    extractedResults: [
  ...
  },
  {
    ...
    status: "processing",
    pageCount: 1,
    ocrSnippet: "THYROID FUNCTION TEST\nPatient: Meera Iyer  Date: 10-Feb-2026\n[OCR extraction in progress — text quality poor on page 1]",
    extractedResults: [],
  },
  {
    id: "rep-5",
    ...
    status: "ready",
    pageCount: 2,
    ocrSnippet: "LIPID PANEL REPORT\nPatient: Karan Patel  Date: 10-Jan-2026\nTotal Cholesterol: 198 mg/dL  [Ref: <200]  NORMAL\nLDL Cholesterol: 118 mg/dL  [Ref: <100]  HIGH\nHDL Cholesterol: 48 mg/dL  [Ref: >50]  LOW",
    extractedResults: [
      { id: "lr-10", patientId: "pat-2", reportId: "rep-5", testName: "Total Cholesterol", value: 198, unit: "mg/dL", referenceMin: 0, referenceMax: 200, date: "2026-01-10" },
      { id: "lr-11", patientId: "pat-2", reportId: "rep-5", testName: "LDL", value: 118, unit: "mg/dL", referenceMin: 0, referenceMax: 100, date: "2026-01-10" },
      { id: "lr-12", patientId: "pat-2", reportId: "rep-5", testName: "HDL", value: 48, unit: "mg/dL", referenceMin: 50, referenceMax: 80, date: "2026-01-10" },
    ],
  },
];
